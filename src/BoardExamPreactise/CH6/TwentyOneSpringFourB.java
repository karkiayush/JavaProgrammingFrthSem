...
public class TwentyOneSpringFourB extends JPanel {
    int javaStudents = 20;
    int phpStudents = 35;
    int pythonStudents = 30;
    int goStudents = 100 - (javaStudents + phpStudents + pythonStudents);

    public static void main(String[] args) {

        TwentyOneSpringFourB fb = new TwentyOneSpringFourB();
        fb.createAndShowGUI();
    }
    ...
    void drawBar(Graphics g, int x, int y, int width, int height, Color color, String label) {
        g.setColor(color);
